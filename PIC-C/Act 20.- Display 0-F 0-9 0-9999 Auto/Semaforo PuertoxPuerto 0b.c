...
void main(){
   ...
   while(true){            
   Port_D = 0b10010001; //1001 0001-> 91H
   delay_ms(500);
   
   Port_D = 0b01000001; //0100 0001-> 81H
   delay_ms(200);
   
   Port_D = 0b00100001; //0010 0001-> 21H
   delay_ms(500);
   
   Port_D = 0b00011001; //0001 1001-> 19H
   delay_ms(500);
   
   Port_D = 0b00010100; //0001 0100-> 18H
   delay_ms(500);
   Port_D = 0b00010010; //0001 0010-> 12H
   }
}
